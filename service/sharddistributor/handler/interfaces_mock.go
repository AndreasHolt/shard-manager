...
func (m *MockHandler) GetNamespaceLoads(arg0 context.Context, arg1 *types.GetNamespaceLoadsRequest) (*types.GetNamespaceLoadsResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNamespaceLoads", arg0, arg1)
...
func (mr *MockHandlerMockRecorder) GetNamespaceLoads(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNamespaceLoads", reflect.TypeOf((*MockHandler)(nil).GetNamespaceLoads), arg0, arg1)
}
